...
[![Add Repository](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=6PATyCb&repository=irene_stt&category=integration)
...
2. Добавьте этот репозиторий как Пользовательская интеграция в HACS:
   ...
   - Вставьте ссылку https://github.com/6PATyCb/irene_stt в поле `Репозиторий`
   - Вытерите "Интеграция" в поле `Тип`
3. Нажмите "Скачать" на интеграции Irene STT
4. Перезапустите Home Assistant

### Ручная установка

1. Скопируйте `custom_components/irene_stt` директорию в ваш Home Assistant `custom_components` директорию
2. Перезапустите Home Assistant

### Настройка

Перейдите в раздел `Настройки` -> `Устройства и службы`, нажмите кнопку `Добавить интеграцию` и в поиске введите `Irene STT`. Далее укажите ссылку до запущенной Ирины, у меня она выглядит так:
```
